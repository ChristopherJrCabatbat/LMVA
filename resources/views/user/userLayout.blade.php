    ...
    {{-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            profileModalEl.addEventListener('hide.bs.modal', function() {
                profileModalEl.querySelector('.modal-dialog').classList.add(
                    'slide-down'); // Add class for slide-down animation
            });

            // Remove the slide-down class after the modal is hidden
            profileModalEl.addEventListener('hidden.bs.modal', function() {
                profileModalEl.querySelector('.modal-dialog').classList.remove(
                    'slide-down'); // Reset after hidden
            });

            // Show the modal if there are validation errors (Laravel $errors)
            @if ($errors->any())
                profileModal.show();
            @endif
        });
